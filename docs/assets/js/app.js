...
// Ejemplo contrucción de objetos
$('#ejemploObjet4').click(function(){
...
// Ejemplo2 contrucción de objetos
$('#ejemploObjet5').click(function(){
	...
	var movil = {
	  ...
	  document.getElementById("elementoprueba2").innerHTML = movil.encendido();
});

// Ejemplo1 del DOM
var parrafos = document.getElementsByTagName("p");
var ejemploDom1 = document.getElementById("ejemploDom1");
	
console.log('***** Ejemplo 1 del DOM *****')
console.log(parrafos)

ejemploDom1.addEventListener('click', function (event) {
    alert('Esta página tiene ' + parrafos.length + ' párrafos en total')
});

// Ejemplo2 del DOM
var parrafoConNombre = document.getElementsByName('parrafoConNombre');
var ejemploDom2 = document.getElementById("ejemploDom2");

console.log('***** Ejemplo 2 del DOM *****')
console.log(parrafoConNombre)

ejemploDom2.addEventListener('click', function (event) {
    alert('Esta página tiene ' + parrafoConNombre.length + 'parrafos con un nombre asignado, y dice los siguiente: ' + parrafoConNombre[0].innerText);    
});

// Ejemplo3 del DOM
var parrafoConId = document.getElementById("parrafoConId");
var ejemploDom3 = document.getElementById("ejemploDom3");

console.log('***** Ejemplo 3 del DOM *****')
console.log(parrafoConId)

ejemploDom3.addEventListener('click', function (event) {
    alert('Esta página tiene un parrafos con un id asignado, y dice los siguiente: ' + parrafoConId.innerText);    
});

document.querySelector('#prueba #id3.clase')
// var id = document.getElementById("pedro");
// var pres = id.getElementsByTagName("pre");
// console.log(pres.length);


//// Ejemplo4 del DOM
$('#ejemploDom4').click(function(){
	// Crear variable para seleccionar sección
	var seccion = document.getElementById("contParrafos");

	// Crear nodo de tipo Element
	var parrafo = document.createElement("p");
	 
	// Crear nodo de tipo Text
	var contenido = document.createTextNode("Yo soy un párrafo creado con JavaScrip");
...
//// Ejemplo5 del DOM
$('#ejemploDom5').click(function(){

	// Recogemos el elemento por id
	var paraBorrar = document.getElementById("paraBorrar");
	 
	// Se invoca a la función removeChild() desde el valor 
	// parentNode del nodo que se quiere eliminar
